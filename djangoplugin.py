...
class DjangoAppPlugin(plugins.SimplePlugin):
    ...
    def start(self):
        ...
        # Admin static handler. From django's internal
        #(django.core.servers.basehttp)
        admin_static_dir = os.path.join(django.__path__[0],
        ...
        cherrypy.tree.mount(admin_static_handler,
                            #urlparse.urljoin(settings.STATIC_URL, 'admin'))
                            urllib.parse.urljoin(settings.STATIC_URL, 'admin'))

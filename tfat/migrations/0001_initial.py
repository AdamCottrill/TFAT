    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tagdoc",
                    models.CharField(
                        null=True, db_index=True, max_length=6, blank=True
                    ),
                ),
                (
                    "tagstat",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dbase",
                    models.ForeignKey(to="tfat.Database", on_delete=models.CASCADE),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "flen",
                    models.IntegerField(
                        verbose_name="Fork Length", null=True, blank=True
                    ),
                ),
                (
                    "tlen",
                    models.IntegerField(
                        verbose_name="Total Length", null=True, blank=True
                    ),
                ),
                (
                    "rwt",
                    models.IntegerField(
                        verbose_name="Round Weight", null=True, blank=True
                    ),
                ),
                (
                    "sex",
                ...
                (
                    "clipc",
                    models.CharField(
                        verbose_name="Clip Code", null=True, max_length=5, blank=True
                    ),
                ),
                ("tagid", models.CharField(db_index=True, max_length=10)),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        verbose_name="Report Date", null=True, blank=True
                    ),
                ),
                (
                    "date_flag",
                ...
                (
                    "associated_file",
                    models.FileField(null=True, upload_to="reports", blank=True),
                ),
                ("comment", models.CharField(null=True, max_length=500, blank=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                related_name="Report", to="tfat.Report", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="recovery",
            name="spc",
            field=models.ForeignKey(
                related_name="Species", to="tfat.Species", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            ...
            name="project",
            field=models.ForeignKey(
                related_name="Encounters", to="tfat.Project", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="encounter",
            name="spc",
            field=models.ForeignKey(to="tfat.Species", on_delete=models.CASCADE),
        ),
        migrations.AlterIndexTogether(
            name="recovery", index_together=set([("tagid", "tagdoc", "spc")])
        ),
        migrations.AlterIndexTogether(
            name="encounter", index_together=set([("tagid", "tagdoc", "spc")])
        ),
    ]

...
def test_encounter_detail(client, project, species):
    ...
    response = client.get(reverse('encounter_detail',
                                  kwargs={'encounter_id':encounter.id}))
...
def test_encounter_panel_headings(client, project, species):
    ...
    headings = ['Encounter Details', 'Tag Attributes', 'Encounter Location',
                'Fish Attributes', 'Additional Comments']
...
def test_encounter_details_with_location_info(client, project, species):
    ...
    encounter = EncounterFactory(project=project,
                               spc=species,
                               grid=grid, dd_lat=dd_lat, dd_lon=dd_lon)

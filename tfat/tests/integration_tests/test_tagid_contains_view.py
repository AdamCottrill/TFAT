...
def test_tagid_reported_but_not_observed(client, db_setup):
    ...
    tagid = 6543
    url = reverse('tagid_contains', kwargs={'partial':tagid})
    response = client.get(url)

    content = str(response.content)

    #No UGMLU observations
    msg = ("Tags containing \\'{}\\' have not been observed "
           "in any UGLMU project.")
...
def test_tagid_observed_but_not_reported(client, db_setup):
    ...
    #No Angler reports
    msg = ("There are no reports of tags containing \\'{}\\' from "
